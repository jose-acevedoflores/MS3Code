;*********************************************************************
; XGATE code
;$Id: xgate.s,v 1.106.2.3 2013/05/22 13:48:01 jsmcortina Exp $
...
.globl xgate_isr, XGATE_CODE_FLASH, XGATE_CODE_FLASH_END, XGATE_DUMMY_ISR_FLASH, xgss_tc1, xgss_inj1, xgss_inj2, xgss_inj3, xgss_inj4, xgss_inj5, xgss_inj6, xgss_inj7, xgss_inj8, xgss_inj9, xgss_inj10, xgss_xgate0, xgss_xgate1, xgss_tc6, xgss_xgate2, xgss_tc3, xgss_xgate3, xgss_tc7, cam_tc4, cam_tc5, crank_tc0, xgss_pit2
...
;debug
    or      r5,r0,r7  ; mov
    lsl     r5,#1
    sub     r5,#2 ; assumes input data was 1-8
    ldw     r4,#outpc.sensors0+17 ; low byte of sensors[8]
    stb     r6,(r4,r5)
;end debug
...
;debug - save a copy of the crank tooth no. at the reset pin
    ldw     r1, #tooth_no
    ldb     r3, (r0,r1)
;    ldw     r1, #outpc.istatus5+1 ; note NOT aligned. byte use only
;    stb     r3, (r0,r1)
...
;    sub     r2,#1 ; <--- broken
;    add     r2,#1 ; <--- broken
; ends up subtracting or adding zero
; must do the high/low bytes directly.
